...
Output: Concise, structured brief (3–5 sections, ~2–3 pages) in PM voice.
...
**Done when**: You have sections ordered by: what's happening, why, and what's next.

Sections (in order):
1. **Executive Summary** (1 para): Execution status + strategic bearing.
2. **Execution Snapshot** (4–6 bullets): Green signals, red signals, yellow flags.
3. **Why It Matters** (1 para): Root causes, second-order effects, capacity constraints.
4. **Strategic Outlook** (1 para): Roadmap progress, market timing, competitive position.
5. **Next Priorities** (3–5 actions): Owner, success criterion, target date. Rank by execution unblock + strategy progress.
...
- **Tone**: Direct PM voice. Balance optimism (green signals) with candour (red signals). No jargon; explain why it matters to leadership.
- **Audience**: PO, leadership team. Assume tech fluency but no sprint-level detail.
- **Length**: Aim for 2–3 pages. If longer, push specialist detail to appendix or link to Confluence.
